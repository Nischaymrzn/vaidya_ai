    ...
    <div className="bg-white">
      ...
      <main>
        ...
        <div className="relative h-full pb-16 overflow-hidden bg-gray-900 isolate pt-14 sm:pb-20">
          <img
            src="https://images.pexels.com/photos/1250655/pexels-photo-1250655.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1&blend=111827&sat=-50&exp=10&blend-mode=multiply&fbclid=IwAR0jhVoCfQtm5wzeMB-3FQXDWhxFY_w6UYwq9hJ1FHn-aH2DTiicmMXTREE"
            alt=""
            ...
            <div className="max-w-4xl py-32 mx-auto sm:py-48 lg:py-56">
              <div className="text-center">
                <h1 className="text-3xl font-bold tracking-tight text-white sm:text-6xl">
                  Transforming Personal Healthcare Through Intelligent Insights
                </h1>

                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Welcome to Vaidya, where we believe in empowering individuals to take control of their health by combining medical knowledge with intelligent digital assistance,
                  specializing in personalized health monitoring, AI-guided consultations, and data-driven wellness insights.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20">
            ...
            <div className="px-6 mx-auto max-w-8xl lg:px-8">
              <div className="max-w-3xl mx-auto sm:text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Our platform provides a secure and intelligent health environment where users can track vital health metrics,
                  manage medical records, consult AI-powered specialists, and receive personalized insights, empowering
                  individuals and families to make informed healthcare decisions through continuous monitoring and data-driven guidance.
                </p>
              </div>
            </div>
          ...
          <div className="py-20 mt-20 bg-gray-900 sm:py-30 sm:mt-38">
            <div className="px-6 mx-auto max-w-7xl lg:px-8">
              ...
              <ul
                role="list"
                className={`grid mt-20 gap-x-8 gap-y-14 items-center justify-center ${
                  teamMembers.length === 1
                    ? "max-w-sm grid-cols-1 mx-auto"
                    : "max-w-2xl grid-cols-1 mx-auto sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 xl:grid-cols-3"
                }`}
              >
            ...
            <dl className="mt-10 space-y-6 divide-y divide-gray-900/10">
              {(faqs as FaqItem[]).map((faq) => (
                <details key={faq.question} className="pt-6 group">
                  <summary className="flex items-start justify-between w-full text-left text-gray-900 cursor-pointer list-none">
